...
import com.abc.kzvideodownloader.utils.Constants.STARTFOREGROUND_ACTION
import com.abc.kzvideodownloader.utils.Constants.STOPFOREGROUND_ACTION
...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adRequest = AdRequest.Builder().addTestDevice("22FA3A9362C0D69F08D6DFB5EE1A3A74").build()
