...
import static com.abc.kzvideodownloader.utils.Constants.PREF_APPNAME;
...
public class iUtils {
    ...
    public static void tintMenuIcon(Context context, MenuItem item, int color) {
        ...
        if (drawable != null) {
            ...
            drawable.mutate();
            drawable.setColorFilter(getColor(context, color), PorterDuff.Mode.SRC_ATOP);
        }
    }
    ...
    public static void  ShowToast(Context context , String str){
        ...
        if (str.equals("Downloading Start!")) {
