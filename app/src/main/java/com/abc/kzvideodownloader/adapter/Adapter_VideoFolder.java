package com.abc.kzvideodownloader.adapter;
...
import com.abc.kzvideodownloader.model.Model_Video;
...
import static com.abc.kzvideodownloader.utils.Constants.DEL_CONFIRM;
...
public  class Adapter_VideoFolder extends RecyclerView.Adapter<Adapter_VideoFolder.ViewHolder> {
    ...
    public Adapter_VideoFolder(Context context, ArrayList<Model_Video> al_video) {
